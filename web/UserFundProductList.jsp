...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <div class="header-body">
            ...
            <%--       搜索的表单、包含分页跳转查询     --%>
            <form id="search" action="/queryUserFundProduct" class="search">
        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">用户投资基金列表</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="/toUpdateUserFundProduct?id=${userItem.id}">
                                                        <button class="dropdown-item" type="button">修改</button>
                                                    </a>
                                                    <a href="/deleteUserFundProduct?id=${userItem.id}">
