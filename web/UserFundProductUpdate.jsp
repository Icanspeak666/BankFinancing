    ...
    <div class="container-fluid">
        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="#">用户投资基金模块</a></li>
                    <li class="breadcrumb-item active" aria-current="page">用户投资基金修改</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <%--                        <h5 class="card-title">银行卡修改</h5>--%>
                        <form action="/updateUserFundProduct" method="post">
                            <input type="hidden" name="id" value="${updateUserFundProduct.id}"/>
                            <%--                            --%>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="userid" class="form-control"
                                               id="colFormLabelLg" required="required" value="${updateUserFundProduct.userid}"
                                               placeholder="用户id">
                                    </div>
                                </div>
                            </c:if>
                            <div class="form-group row">
                                <label for="colFormLabelSm"
                                       class="col-sm-2 col-form-label col-form-label-sm">基金产品</label>
                                <div class="col-sm-10">
                                    <select name="fundid" class="form-control form-control-sm"
                                            id="colFormLabelSm">

                                        <c:forEach items="${fundProducts}" var="fundProductItem">
                                            <option
                                                    <c:if test="${fundProductItem.id==updateUserFundProduct.fundid}">selected</c:if>
                                                    value="${fundProductItem.id}">${fundProductItem.funddesc}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="starttime" class="form-control"
                                           id="CarFormLabelLg" required="required" value="${updateUserFundProduct.starttime}"
                                           placeholder="开始时间">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="endtime" class="form-control"
                                           id="colFormbalance" required="required" value="${updateUserFundProduct.endtime}"
                                           placeholder="结束时间">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="status" class="form-control form-control-sm"
                                            id="colFormdefaultl">
                                        <option <c:if test="${updateUserFundProduct.status==1}">selected</c:if>
                                                value="1">持有中</option>
                                        <option <c:if test="${updateUserFundProduct.status==2}">selected</c:if>
                                                value="2">已失效</option>
                                        <option <c:if test="${updateUserFundProduct.status==3}">selected</c:if>
                                                value="3">已撤销</option>
                                    </select>
                                </div>
                            </div>
