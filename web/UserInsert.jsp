        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="#">用户模块</a></li>
                    <li class="breadcrumb-item active" aria-current="page">用户添加</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="username" class="form-control form-control-sm"
                                           id="colFormLabelSm"  required="required" value="${user.username}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="password" class="form-control"
                                           id="CarFormLabelLg"  required="required" value="${user.password}"
                                           placeholder="password">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelLg"
                                       class="col-sm-2 col-form-label">身份ID</label>
                                <div class="col-sm-10">
                                    <input type="text" name="idcard" class="form-control"
                                           id="colFormLabelLg" required="required" value="${user.idcard}"
                                           placeholder="身份证号">
                                </div>
                            </div>
                            <div class="form-group row">
