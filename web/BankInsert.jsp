        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">银行添加</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
...
<%--                        <h5 class="card-title">银行添加</h5>--%>
                        <form action="/insertBank" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control form-control-sm"
                                           id="colFormLabelSm" required="required" value="${bank.name}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="type" required="required" value="${bank.type}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="assets" class="form-control"
                                           id="CarFormLabelLg" required="required" value="${bank.assets}"
                                           placeholder="资产">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="bankdesc" class="form-control"
                                           id="colFormLabelLg" required="required" value="${bank.bankdesc}"
                                           placeholder="描述">
                                </div>
                            </div>
                            <div class="form-group row">
