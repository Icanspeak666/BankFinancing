...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <div class="header-body">
            ...
            <%--       搜索的表单、包含分页跳转查询     --%>
            <form id="search" action="/queryFundProductUser" class="search">
        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">基金理财产品列表</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${list}" var="fundProductItem">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <button type="button"
                                                    onclick="selectedFund('${fundProductItem.id}','${fundProductItem.funddesc}')"
