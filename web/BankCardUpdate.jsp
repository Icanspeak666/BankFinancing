        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="#">银行卡模块</a></li>
                    <li class="breadcrumb-item active" aria-current="page">银行卡修改</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
...
<%--                        <h5 class="card-title">银行卡修改</h5>--%>
                        <form action="/updateBankCard" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="type" class="form-control form-control-sm"
                                            id="colFormLabel">
                                        <option <c:if test="${updateBankCard.type==1}">selected</c:if>
                                                value="1">借记卡</option>
                                        <option <c:if test="${updateBankCard.type==2}">selected</c:if>
                                                value="2">信用卡</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardnum" class="form-control"
                                           id="CarFormLabelLg" required="required" value="${updateBankCard.cardnum}"
                                           placeholder="银行卡号">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="userid" class="form-control"
                                           id="colFormLabelLg" required="required" value="${updateBankCard.userid}"
                                           placeholder="用户id">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="balance" class="form-control"
                                           id="colFormbalance" required="required" value="${updateBankCard.balance}"
                                           placeholder="金额">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="defaultl" class="form-control form-control-sm"
                                            id="colFormdefaultl">
                                        <option <c:if test="${updateBankCard.defaultl==1}">selected</c:if>
                                                value="1">默认</option>
                                        <option <c:if test="${updateBankCard.defaultl==2}">selected</c:if>
                                                value="2">不默认</option>
                                    </select>
                                </div>
                            </div>
