        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">用户投资基金添加</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/insertUserFundProduct" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="userid" class="form-control"
                                           id="colFormLabelLg" required="required" value="${userFundProduct.userid}"
                                           placeholder="用户id">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="colFormLabelSm"
                                       class="col-sm-2 col-form-label col-form-label-sm">理财基金产品</label>
                                <div class="col-sm-10">
                                    <select name="fundid" class="form-control form-control-sm"
                                            id="colFormLabelSm">
                                        <c:forEach items="${fundProducts}" var="fundProductItem">
                                            <option value="${fundProductItem.id}">${fundProductItem.funddesc}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="starttime" class="form-control"
                                           id="colFormStart" value="${userFundProduct.starttime}"
                                           placeholder="开始时间">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="starttime" class="form-control"
                                           id="colFormEnd" value="${userFundProduct.endtime}"
                                           placeholder="结束时间">
                                </div>
                            </div>
                            <div class="form-group row">
