...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <div class="header-body">
            ...
            <%--       搜索的表单、包含分页跳转查询     --%>
            <form id="search" action="/queryBankCard" class="search">
        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">银行卡列表</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <c:if test="${nowUser!=null}">
                                                        <a href="/toUpdateBankCardUser?id=${userItem.id}">
                                                            <button class="dropdown-item" type="button">修改</button>
                                                        </a>
                                                    </c:if>
                                                    <c:if test="${nowAdmin!=null}">
                                                        <a href="/toUpdateBankCard?id=${userItem.id}">
                                                            <button class="dropdown-item" type="button">修改</button>
                                                        </a>
                                                    </c:if>
                                                    <a href="/deleteBankCard?id=${userItem.id}">
