        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">银行卡添加</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
...
<%--                        <h5 class="card-title"></h5>--%>
                        <form action="/insertBankCard" method="post">
                            <%--                            --%>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardnum" class="form-control"
                                           id="CarFormLabelLg" required="required" value="${bankCard.cardnum}"
                                           placeholder="银行卡号">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="userid" class="form-control"
                                           id="colFormLabelLg" required="required" value="${bankCard.userid}"
                                           placeholder="用户id">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="balance" class="form-control"
                                           id="colFormbalance" required="required" value="${bankCard.balance}"
                                           placeholder="金额">
                                </div>
                            </div>
                            <div class="form-group row">
