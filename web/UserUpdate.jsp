                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="username" class="form-control form-control-sm"
                                           id="colFormLabelSm"  required="required" value="${updateUser.username}"
                                           placeholder="用户名">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="password"  required="required" value="${updateUser.password}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="idcard" class="form-control"
                                           id="CarFormLabelLg"  required="required" value="${updateUser.idcard}"
                                           placeholder="身份证号">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" name="email" class="form-control"
                                           id="colFormLabelLg" required="required" value="${updateUser.email}"
                                           placeholder="Email">
                                </div>
                            </div>
                            <div class="form-group row">
