        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">基金理财产品修改</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/updateFundProduct" method="post">
                            <input type="hidden" name="id" value="${updateFundProduct.id}"/>
                            <%--                            --%>
                            <div class="form-group row">
                                <label for="colFormLabelSm"
                                       class="col-sm-2 col-form-label col-form-label-sm">基金类型</label>
                                <div class="col-sm-10">
                                    <select name="type" class="form-control form-control-sm"
                                            id="colFormLabelSm">

                                        <option <c:if test="${updateFundProduct.type==1}">selected</c:if>
                                                value="1">股票型基金</option>
                                        <option <c:if test="${updateFundProduct.type==2}">selected</c:if>
                                                value="2">债券型基金</option>
                                        <option <c:if test="${updateFundProduct.type==3}">selected</c:if>
                                                value="3">货币型基金</option>
                                        <option <c:if test="${updateFundProduct.type==4}">selected</c:if>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="code" class="form-control"
                                           id="CarFormLabelLg" required="required" value="${updateFundProduct.code}"
                                           placeholder="基金代码">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="funddesc" class="form-control"
                                           id="colFormLabelLg" required="required" value="${updateFundProduct.funddesc}"
                                           placeholder="基金简称">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="dailygrowth" class="form-control"
                                           id="colFormbalance" required="required" value="${updateFundProduct.dailygrowth}"
                                           placeholder="日增长率">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="leastmoney" class="form-control"
                                           id="colFormleastmoney" required="required" value="${updateFundProduct.leastmoney}"
                                           placeholder="起投金额">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="dailygrowth" class="form-control"
                                           id="colFormprofit" required="required" value="${updateFundProduct.profit}"
                                           placeholder="收益">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="investerm" class="form-control"
                                           id="colForminvesterm" required="required" value="${updateFundProduct.investerm}"
                                           placeholder="投资期限">
                                </div>
                            </div>
                            <div class="form-group row">
