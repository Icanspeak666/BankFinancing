        ...
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">银行修改</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control form-control-sm"
                                           id="colFormLabelSm" required="required" value="${updateBank.name}"
                                           placeholder="银行名称">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="type" required="required" value="${updateBank.type}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="assets" class="form-control"
                                           id="CarFormLabelLg" required="required" value="${updateBank.assets}"
                                           placeholder="银行资产">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="bankdesc" class="form-control"
                                           id="colFormLabelLg" required="required" value="${updateBank.bankdesc}"
                                           placeholder="描述">
                                </div>
                            </div>
                            <div class="form-group row">
